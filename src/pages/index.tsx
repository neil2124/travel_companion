  ...
  return (
    <>
      <MetaTags
        ...
        description="A fully responsive travel companion and weather app developed using a combination of the Google Maps API, Travel Advisor API, and WeatherAPI.com. Built with Next.js and TypeScript, the app allows users to search for locations and retrieve data on restaurants, hotels, and attractions based on their location."
        url=""
        image=""
      />
